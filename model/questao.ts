...
export default class QuestaoModel {
    ...
    responderCom(indice: number): QuestaoModel {
        ...
        const respostas = this.#respostas.map((resposta, i) => {
            ...
            const revelar = respostaSelecionada || resposta.certa
            return revelar ? resposta.revelar() : resposta 
        })
        return new QuestaoModel(this.id, this.enunciado, respostas, acertou, true)
    }
